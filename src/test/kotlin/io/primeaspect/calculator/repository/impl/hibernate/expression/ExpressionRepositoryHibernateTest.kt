...
@SpringBootTest(classes = [
    ...
    ExpressionRepositoryHibernate::class
], properties = ["spring.liquibase.change-log=classpath:db/changelog.xml"])
@ComponentScan(basePackages = ["io.primeaspect.calculator"])
@EnableJpaRepositories(basePackageClasses = [ExpressionCrudRepository::class])
class ExpressionRepositoryHibernateTest {
    @Autowired
    private lateinit var repository: ExpressionRepositoryHibernate
